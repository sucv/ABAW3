...
if __name__ == '__main__':
    ...
    # 1.2. Paths
    parser.add_argument('-dataset_path', default='/home/zhangsu/dataset/abaw3', type=str,
                        help='The root directory of the preprocessed dataset.')  # /scratch/users/ntu/su012/dataset/mahnob
    parser.add_argument('-load_path', default='/home/zhangsu/load_path', type=str,
                        help='The path to load the trained model, such as the backbone.')  # /scratch/users/ntu/su012/pretrained_model
    parser.add_argument('-save_path', default='/home/zhangsu/save_path', type=str,
                        help='The path to save the trained model ')  # /scratch/users/ntu/su012/trained_model
    parser.add_argument('-python_package_path', default='/home/zhangsu/ABAW3', type=str,
    ...
    parser.add_argument('-experiment_name', default="ABAW3", help='The experiment name.')
    ...
    parser.add_argument('-modality', default=['video', 'bert', 'vggish', 'VA_continuous_label'], nargs="*")
    ...
    parser.add_argument('-model_name', default="LFA", help='Leader-follower attention')
